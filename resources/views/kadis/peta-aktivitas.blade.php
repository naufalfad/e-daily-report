            ...
            <div class="p-6 overflow-y-auto max-h-[70vh]">
                ...
                <template x-if="selectedActivity">
                    <div>
                        ...
                        {{-- Judul Kegiatan --}}
                        <h2 class="text-lg font-bold text-slate-900 leading-snug mb-4" x-text="selectedActivity.kegiatan">
                        </h2>
                        ...
                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-100 grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div class="col-span-2 pt-2 border-t border-slate-200/60">
                                <label class="text-[10px] uppercase font-bold text-slate-400 mb-1 block">Uraian
                                    / Deskripsi</label>
                            ...
                            <div class="col-span-2 pt-2 border-t border-slate-200/60">
                                <label class="text-[10px] uppercase font-bold text-slate-400 mb-1 block">Lokasi
                                    Tercatat</label>
