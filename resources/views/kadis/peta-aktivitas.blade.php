    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6 relative z-10">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                {{-- Loading Spinner --}}
                <div x-show="loading" class="text-xs font-semibold text-blue-600 flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full border border-blue-100 animate-pulse" style="display: none;">
