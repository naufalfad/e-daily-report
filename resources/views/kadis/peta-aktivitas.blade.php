...
<section x-data="kadisMapData" x-init="initMap()" class="relative">
    ...
    <div class="rounded-2xl bg-white ring-1 ring-slate-200 p-5 relative z-10">
        ...
        {{-- LEGENDA --}}
        <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-medium text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
    ...
    >
        ...
        {{-- Modal Panel --}}
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all ring-1 ring-slate-200 flex flex-col max-h-[90vh]">
            ...
            <div class="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center shrink-0">
                ...
                <button @click="closeModal()" class="text-slate-400 hover:text-rose-500 p-2 rounded-full hover:bg-rose-50 transition-colors">
            ...
            <div class="p-6 overflow-y-auto">
                <template x-if="selectedActivity">
                    <div>
                        {{-- Kategori Badge --}}
                        <span class="inline-block px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-wide border border-blue-100 mb-2"
                        ...
                        <div class="flex items-center gap-3 mb-6">
                            <span class="px-2.5 py-1 text-xs rounded-lg font-semibold border shadow-sm"
                                :class="{
                        ...
                        {{-- Grid Detail --}}
                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-100 grid grid-cols-2 gap-4 text-sm mb-4">
                            <div>
                                <label class="text-[10px] uppercase font-bold text-slate-400 mb-1 block">Tanggal</label>
                            ...
                            <div>
                                <label class="text-[10px] uppercase font-bold text-slate-400 mb-1 block">Waktu</label>
                                <div class="font-semibold text-slate-700 flex items-center gap-2">
                            ...
                            <div class="col-span-2 pt-2 border-t border-slate-200/60">
                                <label class="text-[10px] uppercase font-bold text-slate-400 mb-1 block">Uraian / Deskripsi</label>
                                <div class="text-slate-600 leading-relaxed italic text-justify"
                                     x-text="selectedActivity.deskripsi || '-'"></div>
                            </div>
                            
                            <div class="col-span-2 pt-2 border-t border-slate-200/60">
                                <label class="text-[10px] uppercase font-bold text-slate-400 mb-1 block">Lokasi Tercatat</label>
