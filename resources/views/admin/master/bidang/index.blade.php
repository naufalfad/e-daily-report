    ...
    <div class="bg-white rounded-[24px] shadow-sm ring-1 ring-slate-200/60 overflow-hidden">
        ...
        <div class="p-6 border-b border-slate-100 bg-slate-50/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h6 class="font-semibold text-slate-700">Daftar Bidang</h6>
            ...
            <div class="relative w-full sm:w-72">
                ...
                <input type="text" id="customSearch" 
                    ...
                    placeholder="Cari bidang atau unit kerja...">
            </div>
        </div>
        ...
        <div class="relative">
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse" id="tableBidang">
...
<script>
    ...
    $(document).ready(function() {
        table = $('#tableBidang').DataTable({
            processing: true,
            serverSide: false,
            ajax: "{{ route('admin.master.bidang.index') }}",
            ...
            language: {
                zeroRecords: `<div class="py-8 flex flex-col items-center justify-center text-center">
                                ...
                                <p class="text-slate-500 font-medium">Belum ada data bidang.</p>
                              </div>`,
            ...
            columns: [
                ...
                { data: 'nama_bidang', className: "px-6 py-4 align-middle font-semibold text-slate-700" },
                { 
            ...
            drawCallback: function(settings) {
                let api = this.api();
                $('#total-records').text(`Total ${api.data().count()} Bidang`);
        ...
        $('#formBidang').on('submit', function(e) {
            ...
            let url = id ? `/admin/master/bidang/${id}` : "{{ route('admin.master.bidang.store') }}";
    ...
    function closeModal() {
        ...
        setTimeout(() => { $('#modalBidang').addClass('hidden'); }, 200);
    }

    function deleteData(id) {
        Swal.fire({
            title: 'Hapus Bidang ini?',
            text: "Pastikan tidak ada pegawai di dalam bidang ini.",
            icon: 'warning',
