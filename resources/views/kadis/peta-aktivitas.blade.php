...
{{-- STYLES --}}
@push('styles')
<lin k rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css">
                        ...
                        <template x-if="selectedActivity">
                            <div>
                                ...
                                <h2 class="text-xl font-bold text-slate-800 mt-1 mb-3"
                                    x-text="selectedActivity.kegiatan">
                                </h2>
                            ...
                            <span class=" inline-block px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-600 text-[10px]
                                    ...
                                    <div class="flex items-center gap-3 mb-6">
                                        ...
                                        {{-- Detail --}} <div class="grid grid-cols-2 gap-4 mt-4 text-sm">
                                            <div>
                                            ...
                                            <div
                                                ...
                                                <div class="col-span-2 pt-2 border-t border-slate-200/60">
                                                    <label
                                                        ...
                                                        Tercatat</label>
                                                    <div
                                                        class="text-slate-700 font-medium text-xs flex items-start gap-1">
                                                        <svg class="w-3.5 h-3.5 text-slate-400 mt-0.5 shrink-0"
                                                        ...
                                                        <span
                                                            x-text="selectedActivity.lokasi_teks || 'Koordinat GPS'"></span>
                                                    </div>
                                                </div>
                                            </div>
