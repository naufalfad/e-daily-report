        ...
        <form id="filter-form" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
            ...
            <div class="md:col-span-4">
                ...
                <div class="relative">
                        ...
                        <form id="filter-form" class="grid grid-cols-1 md:grid-cols-12 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select id="filter-year"
                                    ...
                                    <<<<<<< HEAD <option value="{{ $y }}" {{ date('Y') == $y ? 'selected' : '' }}>
                                        {{ $y }}</option>
                            ...
                            {{-- STATUS (DEFAULT: ALL) --}} <div class="md:col-span-2">
                                ...
                                <select id="filter-status"
                                    ...
                                    <div class="md:col-span-2">
                                        <select id="filter-status"
                                            ...
                                            >>>>>>> cfc2cfc3f0c685ca0cc751852970acb926158882
                    ...
                    {{-- CARD TABEL --}}
                    <div
                        class="flex-1 bg-white rounded-2xl ring-1 ring-slate-200 shadow-sm flex flex-col overflow-hidden">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center justify-between">
                    <div>
                        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Status Saat
                            Ini</span>
            ...
            {{-- Lokasi & Bukti --}} <div class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                ...
                <div class="flex-1">
                    ...
                    <button type="button" id="detail-bukti-btn"
                        class="js-open-bukti w-full flex items-center justify-center gap-2 bg-blue-50 text-blue-600 hover:bg-blue-100 px-3 py-2 rounded-lg text-sm font-medium transition border border-blue-200">
            ...
            <div id="modal-detail"
                ...
                <div class="bg-white rounded-2xl w-[95vw] max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl">
                    ...
                    {{-- Header --}}
                    <div
                        class="flex justify-between items-center px-6 py-4 border-b border-slate-200 sticky top-0 bg-white">
                        <div>
                            <h3 class="text-lg font-bold text-slate-800">Detail Laporan Harian</h3>
                    ...
                    {{-- Footer Actions --}} <div id="validation-actions"
                    ...
                    <div id="validation-info"
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div
                                    class="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center justify-between">
                                    <div>
                            ...
                            <div>
                                ...
                                <div
                                    class="p-4 rounded-xl border border-slate-200 bg-white text-sm text-slate-600 leading-relaxed">
                                    <div id="detail-nama" class="font-semibold text-slate-800 mb-1">-</div>
                                    <div id="detail-uraian">-</div>
                                </div>
                            </div>
                            ...
                            <div id="detail-catatan-wrapper"
                                class="hidden bg-yellow-50 p-4 border border-yellow-100 rounded-xl">
                                <div class="text-xs font-bold text-yellow-700 mb-1 uppercase">Catatan Validasi</div>
                                <div id="detail-catatan" class="text-sm text-yellow-800 italic"></div>
                            </div>
                        ...
                        {{-- Sudah tervalidasi --}}
                        <div id="validation-info"
                            class="hidden px-6 py-4 text-center bg-slate-50 border-t border-slate-200">
                ...
                {{-- ================= MODAL LIST BUKTI DOKUMEN (NEW) ================= --}} <div id="modal-bukti-list"
                        ...
                        <div class="mt-6 pt-4 border-t border-slate-100 flex justify-end">
                            <button type="button"
                                ...
                                <div id="modal-approve"
                                    class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
                                    <div
                                        class="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 transform scale-100 transition-all">
                                        <div class="text-center mb-6">
                                            <div
                                ...
                                <div id="modal-reject"
                                    ...
                                    <div
                                        ...
                                        <p id="reject-error" class="hidden text-xs text-rose-600 mb-4 text-left">*
                                            Alasan
                                            wajib
                                            diisi.</p>
                                ...
                                <div class="flex gap-3 mt-4">
                                    <button
                                        class="js-close-reject flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50">
                                        Batal
                                    </button>
