...
<section x-data="penilaiMapData" x-init="initMap()" class="relative">
    ...
    <div class="rounded-2xl bg-white ring-1 ring-slate-200 p-5 relative z-10">
        ...
        {{-- LEGENDA --}}
        <div class="mt-4 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-medium text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-100">
    ...
    >
        ...
        {{-- Modal Panel --}}
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all ring-1 ring-slate-200">
