...
{{-- JS KECIL UNTUK GANTI STYLE MENU + PANEL SAAT DIKLIK --}}
@push('scripts')
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    // default: tampilkan panel sistem
    showPanel('sistem');
    ...
    if (resetAdminCard) {
        resetAdminCard.addEventListener('click', openResetModal);
    }
    if (btnCancelReset) {
        btnCancelReset.addEventListener('click', closeResetModal);
    }
    if (btnSaveReset) {
        btnSaveReset.addEventListener('click', function() {
            // nanti tinggal ganti dengan submit form / ajax
            closeResetModal();
        });
    }

    // tutup modal kalau klik area overlay abu-abu
    if (resetAdminModal) {
