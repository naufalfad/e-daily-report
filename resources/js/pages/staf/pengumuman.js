...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function fetchPengumuman() {
        const endpoint = "/api/pengumuman"; // Endpoint umum untuk Staf
    ...
    function createCard(item) {
        ...
        // Attach Event Listener jika tombol ada
        ...
        try {
            const res = await authFetch("/api/pengumuman", {
                ...
                body: JSON.stringify({
                    ...
                    // Unit kerja ID akan di-handle backend berdasarkan user login
                }),
            });
