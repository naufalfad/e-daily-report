...
@section('content')
    <section x-data="riwayatDataStaf('{{ $role }}')" x-init="initPage()" class="font-poppins">
        ...
        <div x-show="open" x-transition.opacity
            ...
            <div @click.outside="open = false"
                ...
                <div class="p-5 border-t border-slate-100 bg-slate-50 flex justify-end">
                    <button @click="open = false"
                        class="px-6 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-xl text-sm font-bold hover:bg-slate-50 transition-all shadow-sm">
                        Tutup
                    </button>
                </div>
            </div>
